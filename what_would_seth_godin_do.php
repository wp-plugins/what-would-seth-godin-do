...
$defaultdata = array(
	'new_visitor_message' => "<p style='border:thin dotted black; padding:3mm;'>If you're new here, you may want to subscribe to my <a href='".get_option('siteurl')."/feed/'>RSS feed</a>.  Thanks for visiting!</p>",
...
function wwsgd_options_subpanel()
{
	...
	<div class="wrap">
		...
		<h3>Repetition</h3>
		<p>Show the message the first <input type="text" name="repetition" value="<?php echo $wwsgd_settings['repetition']; ?>" size="3" /> times the user visits.</p>
...
function wwsgd_message_filter($content = '')
{
	...
	if ($wwsgd_visits <= $wwsgd_settings['repetition'] && !is_feed())
	{
