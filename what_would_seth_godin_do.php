...
function wwsgd_options_subpanel()
{
	...
	{
		$wwsgd_settings['new_visitor_message'] = stripslashes($_POST['new_visitor_message']); // TODO: These $_POST values need better cleaning and whitelisting
		$wwsgd_settings['message_location'] = attribute_escape($_POST['message_location']);
		$wwsgd_settings['repetition'] = attribute_escape($_POST['repetition']);
